package tgs.com.mvvm.weight.player;
...
import tgs.com.mvvm.callback.MediaPlayerListener;
import tgs.com.mvvm.utils.ScreenResolution;
        ...
        try {
            ...
            if (mUri != null) {
                if(header!=null&&header.size()!=0){
                    mMediaPlayer.setDataSource(mContext,mUri,header);
                    if(header.containsKey("User-Agent")){

                        ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT, "user-agent", header.get("User-Agent"));
                    }
